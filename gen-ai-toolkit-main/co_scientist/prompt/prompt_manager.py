...
if __name__ == '__main__':
    manager = PromptManager("/Users/zepingliu/Library/CloudStorage/OneDrive-TheUniversityofTexasatAustin/PhD/6-Job/ESRI/Spatial_Co_Scientist/co_scientist/prompt")
