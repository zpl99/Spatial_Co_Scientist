...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Process layers and generate FEL data.")
    parser.add_argument("--project_path", type=str,default=r"C:\Users\64963\Documents\ArcGIS\Projects\MyProject9\MyProject9.aprx")
    args = parser.parse_args()
    args.project_path = os.path.normpath(args.project_path)
    ...
    if len(layers_json)==0:
        layers_json = r"../co_scientist/temp_folder/data_context.json"
    ...
    curr_proj = arcpy.mp.ArcGISProject(args.project_path)
