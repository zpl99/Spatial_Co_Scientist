...
async def amazon_bedrock_complete_if_cache(
    ...
    async with amazon_bedrock_async_client.client(
        ...
        if system_prompt:
            ...
            response = await bedrock_runtime.conversex(
                modelId=model, messages=messages, inferenceConfig=inference_config,
            )
...
async def azure_openai_complete_if_cache(
    ...
    # azure_openai_client = get_azure_openai_async_client_instance() #TODO: THIS IS WHAT I EDIT
    azure_openai_client = AsyncAzureOpenAI( api_key="3c744295edda4f13bf0ef198ddb4d24c",
...
async def azure_openai_embedding(texts: list[str]) -> np.ndarray:
    ...
    azure_openai_client = AsyncAzureOpenAI(
        ...
        api_version="2024-10-21",
        azure_endpoint="https://ist-apim-aoai.azure-api.net/load-balancing/text-embedding-3-small"
    )
